#!/usr/bin/env python3
"""Q9 — Cross-sectional momentum (basis/premium) study.

Pré-registrado em docs/estrategias/q9-cross-sectional-momentum-design-20260822.md.
Hipótese inversa da Q8: ativos com premium relativo extremo CONTINUAM, em vez de
reverter.

Mesma mecanismo da Q8 (mesmo basket, mesmo rank causal, mesmo cooldown) — muda
apenas a SINAL-PREDIÇÃO:
- RICH  -> retorno relativo forward POSITIVO (continuação de alta)
- CHEAP -> retorno relativo forward NEGATIVO (continuação de baixa)
...
def main():
    print("🧪 Q9 — cross-sectional momentum (premium/basis)")
    ...
    print("   Hipótese: CONTINUAÇÃO — RICH sobe relativo, CHEAP cai relativo\n")
    ...
    for h in HORIZONS_HOURS:
        ...
        verdicts["RICH"][h] = summarize("RICH (hipótese: continua subindo)", rich, ctrl)
        verdicts["CHEAP"][h] = summarize("CHEAP (hipótese: continua caindo)", cheap, ctrl)
    ...
    print("- Falha se n<30 por lado, OU sinal contrário, OU |marginal| <= custo (20bp).")
