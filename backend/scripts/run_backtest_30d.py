...
async def run_backtest_30d():
    """Executa um backtest de 30 dias para BTC/USDT no modo Auto."""
    # 30 dias em velas de 5 minutos
    limit_30d = 30 * 24 * 60 // 5  # 8640 velas
    ...
    print(f"Executando backtest de 30 dias para {req.symbol}...")
    ...
    print("\n=== Resultado do Backtest de 30 Dias (Modo Auto) ===")
    ...
    with open("backtest_30d_result.json", "w") as f:
        json.dump(result, f, indent=2, default=str)
    print("\nResultado completo salvo em 'backtest_30d_result.json'")

if __name__ == "__main__":
    asyncio.run(run_backtest_30d())