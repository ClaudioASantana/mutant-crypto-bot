"""
Serviço de Domínio para Avaliação de Risco.

Contém regras de negócio puras de gestão de risco — verifica se um trade
pode ser aprovado com base no estado da conta e nos limites diários.
"""
